...
func newLogins(c *ApiV1alpha1Client, namespace string) *logins {
	return &logins{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *logins) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Login, err error) {
	result = &v1alpha1.Login{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("logins").
		Name(name).
...
func (c *logins) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.LoginList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.LoginList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("logins").
...
func (c *logins) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *logins) Create(ctx context.Context, login *v1alpha1.Login, opts v1.CreateOptions) (result *v1alpha1.Login, err error) {
	result = &v1alpha1.Login{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("logins").
...
func (c *logins) Update(ctx context.Context, login *v1alpha1.Login, opts v1.UpdateOptions) (result *v1alpha1.Login, err error) {
	result = &v1alpha1.Login{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("logins").
...
func (c *logins) UpdateStatus(ctx context.Context, login *v1alpha1.Login, opts v1.UpdateOptions) (result *v1alpha1.Login, err error) {
	result = &v1alpha1.Login{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("logins").
...
func (c *logins) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *logins) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *logins) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Login, err error) {
	result = &v1alpha1.Login{}
